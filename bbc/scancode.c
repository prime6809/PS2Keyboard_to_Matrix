...
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP0,			AKEY_0,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP1,			AKEY_1,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP2,			AKEY_2,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP3,			AKEY_3,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP4,			AKEY_4,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP5,			AKEY_5,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP6,			AKEY_6,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP7,			AKEY_7,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP8,			AKEY_8,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KP9,			AKEY_9,

SCAN_CODE_NO_PREFIX,	SCAN_CODE_NUMLOCK,		AKEY_COMMA,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KPPLUS,		AKEY_COLON,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KPMINUS,		AKEY_MINUS,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_KPSTAR,		AKEY_COLON,

SCAN_CODE_ESCAPE,		SCAN_CODE_KPSLASH,		AKEY_SLASH,
SCAN_CODE_ESCAPE,		SCAN_CODE_KPENTER,		AKEY_ENTER,
//SCAN_CODE_ESCAPE,		SCAN_CODE_INSERT,		AKEY_HASH,
SCAN_CODE_ESCAPE,		SCAN_CODE_DELETE,		AKEY_DEL,
