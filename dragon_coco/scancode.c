...
SCAN_CODE_NO_PREFIX,	SCAN_CODE_SEMICOLON,	COCO_KEY_SEMI,
...
SCAN_CODE_NO_PREFIX,	SCAN_CODE_MINUS,		COCO_KEY_COLON,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_EQUAL,		COCO_KEY_EQUAL,
...
SCAN_CODE_ESCAPE,		SCAN_CODE_LARROW,		COCO_KEY_LEFT,
SCAN_CODE_ESCAPE,		SCAN_CODE_RARROW,		COCO_KEY_RIGHT,
SCAN_CODE_ESCAPE,		SCAN_CODE_UARROW,		COCO_KEY_UP,
SCAN_CODE_ESCAPE,		SCAN_CODE_DARROW,		COCO_KEY_DOWN,

SCAN_CODE_ESCAPE,		SCAN_CODE_HOME,			COCO_KEY_CLEAR,
...
SCAN_CODE_NO_PREFIX,	SCAN_CODE_SEMICOLON,	DRAGON_KEY_SEMI,
...
SCAN_CODE_NO_PREFIX,	SCAN_CODE_MINUS,		DRAGON_KEY_COLON,
SCAN_CODE_NO_PREFIX,	SCAN_CODE_EQUAL,		DRAGON_KEY_EQUAL,
//SCAN_CODE_NO_PREFIX,	SCAN_CODE_TILDE,		DRAGON_KEY_CLARET,

SCAN_CODE_NO_PREFIX,	SCAN_CODE_BACKSPACE,	DRAGON_KEY_LEFT,
...
SCAN_CODE_ESCAPE,		SCAN_CODE_LARROW,		DRAGON_KEY_LEFT,
SCAN_CODE_ESCAPE,		SCAN_CODE_RARROW,		DRAGON_KEY_RIGHT,
SCAN_CODE_ESCAPE,		SCAN_CODE_UARROW,		DRAGON_KEY_UP,
SCAN_CODE_ESCAPE,		SCAN_CODE_DARROW,		DRAGON_KEY_DOWN,

SCAN_CODE_ESCAPE,		SCAN_CODE_HOME,			DRAGON_KEY_CLEAR,
